$(document).ready(function () {
    plot1 = $.jqplot("mastery-winrate", [winrateData], {
        seriesDefaults: {
            ...
            rendererOptions: {
                autoscalePointsFactor: -.25,
                autoscaleMultiplier: .25,
                bubbleAlpha: .7,
                highlightAlpha: 1
            },
            shadow: true,
        ...
        axes: {
            xaxis: {
                ...
                labelOptions: {fontFamily: "'Muli', sans-serif", fontSize: "16pt", textColor: "#101010"}
            },
            yaxis: {
                showTicks: true,
                label: "Winrate",
...
function moveBubbles() {
    series = document.getElementsByClassName("jqplot-series-canvas");
    Object.keys(series).forEach(function (i) {
        divs = series[i].getElementsByTagName("div");
        Object.keys(divs).forEach(function (j) {
            var currTop = divs[j].style.top;
            currTop = currTop.split("p")[0];
            newTop = currTop - 70;
            divs[j].style.top = newTop += "px";
        });
    });
}
